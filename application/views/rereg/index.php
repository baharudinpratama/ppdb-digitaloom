    ...
    <div class="d-flex align-items-center gap-4" style="margin-bottom: 4rem;">
        <div class="d-flex flex-fill p-4 rounded-4 bg-white">
            <div class="d-flex align-items-center gap-3">
                <img src="<?= base_url('assets/img/rereg/not-upload.png') ?>" alt="not upload" class="rounded-3">
                <div class="d-flex flex-column fw-bold">
                    <p>Belum Tes</p>
                    <p style="color: #D9AA00;"><span style="font-size: 2rem;"><?= $count_uploaded ?></span> Peserta</p>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex flex-fill p-4 rounded-4 bg-white">
            <div class="d-flex align-items-center gap-3">
                <img src="<?= base_url('assets/img/rereg/upload.png') ?>" alt="upload" class="rounded-3">
                <div class="d-flex flex-column fw-bold">
                    <p>Lolos Tes</p>
                    <p style="color: #43B638;"><span style="font-size: 2rem;"><?= sizeof($students) - $count_uploaded ?></span> Peserta</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <table id="table" class="table table-responsive w-100 align-middle">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Status<br>Dokumen</th>
                ...
                <?php foreach ($students as $student) : ?>
                    <tr>
                        ...
                        <td class="fw-semibold text-center">
                            ...
                            switch (sizeof($student->uploads) > 0) {
                                case true:
                                    $text = 'Sudah Upload';
